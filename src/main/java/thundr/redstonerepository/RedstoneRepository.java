...
public class RedstoneRepository {
    ...
    public static final String REQUIRED = "required-after:redstonearsenal@[2.3.11,);" + "required-after:cofhcore@[4.3.11,);" + "required-after:thermalexpansion@[5.3.11,);" + "after:baubles;";
